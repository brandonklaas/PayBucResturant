...
public class BranchManagementPanel extends javax.swing.JPanel {
     ...
     */
    public BranchManagementPanel(Session session) {
    ...
    public void refreshTable(){
        ...
        tableModel.addColumn("Branch Code");
        
        array = database.getBranches();
        
        if(array.size() > 0){
            for(Branch branch : array){
                tableModel.addRow(new Object[]{branch.getName(), branch.getAddress(), branch.getBranchNo()});
            }
        }
        
        branchTb.setModel(tableModel);
        branchTb.repaint();
        branchTb.validate();
    }
    ...
    private void initComponents() {
        ...
        branchTb = new javax.swing.JTable();
        ...
        branchTb.setBackground(new java.awt.Color(255, 255, 255));
        branchTb.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        branchTb.setForeground(new java.awt.Color(51, 51, 51));
        branchTb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        branchTb.setGridColor(new java.awt.Color(204, 204, 204));
        branchTb.setOpaque(false);
        jScrollPane1.setViewportView(branchTb);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        new Dialogue(null, true, new BranchDialogue(session, this), "Branch Management");
    }//GEN-LAST:event_addBtnActionPerformed

    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        // TODO add your handling code here:
        if(branchTb.getSelectedRow() > -1){
            if(database.delete(array.get(branchTb.getSelectedRow()))){
                new OkayDialogue(null, true, "Branch Deleleted Successfully");
                refreshTable();
            } else {
                new OkayDialogue(null, true, "Failed to Branch");
            }
        } else {
            new OkayDialogue(null, true, "Select Branch to delete");
        }
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        // TODO add your handling code here:
        if(branchTb.getSelectedRow() > -1){
            new Dialogue(null, true, new BranchDialogue(session, this, array.get(branchTb.getSelectedRow())), "Branch Management");
        } else {
            new OkayDialogue(null, true, "Select Branch to edit");
        }
    ...
    private javax.swing.JTable branchTb;
