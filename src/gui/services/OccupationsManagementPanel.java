 ...
 * @author brand
 */
public class OccupationsManagementPanel extends javax.swing.JPanel {

    private Session session;
    private DatabaseAccessObject database;
    private DefaultTableModel tableModel;
    private ArrayList<Occupation> array;
    
    /**
     * Creates new form Services
     */
    public OccupationsManagementPanel(Session session) {
    ...
    public void refreshTable(){
        ...
        tableModel.addColumn("Occupation Title");
        tableModel.addColumn("Occupation Responsibilities");
        
        array = database.getOccupations();
        
        if(array.size() > 0){
            for(Occupation occupation : array){
                tableModel.addRow(new Object[]{occupation.getTitle(), occupation.getResponsibilities()});
            }
        }
